...
// import { useEffect, useState } from "react";
// import axios from "axios";
// import { UserCircleIcon, MailIcon, UserIcon, UserCheck2, GraduationCap } from "lucide-react";
...
//         <ProfileItem icon={<Mail className="h-5 w-5" />} label="Email" value={user.email} />
//         <ProfileItem icon={<BadgeInfo className="h-5 w-5" />} label="Unique ID" value={user.uniqueId} />
//         <ProfileItem icon={<UserCheck className="h-5 w-5" />} label="Role" value={user.role} />
